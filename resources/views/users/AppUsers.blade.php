...
<body>
    ...
    <div class="footer">
        <div class="heading">
          <h2 style="color: #ffffff">PCTOOLS<sup>™</sup></h2>
        </div>
        <div class="content">
          <div class="services">
            <h4>Services</h4>
            <p><a href="#">Buy PC Tools</a></p>
            <p><a href="#">Sell PC Tools</a></p>
            <p><a href="#">PC Tools Info</a></p>
          </div>
          ...
          <div class="details">
            ...
            <p><a style="display: flex;align-items: flex-start;flex-direction: row;justify-content: center;"  href="#"><img class="svgimg" style="height: 20px;width: 20px;margin-right:7px;cursor: pointer;" src = "{{ asset('images/phone-svgrepo-com.svg') }}" alt="about-solid SVG"/>+212-1222553810</a></p>
            <h4 class="mail">Email</h4>
            <p><a style="display: flex;align-items: flex-start;flex-direction: row;justify-content: center;"  href="#"><img class="svgimg" style="height: 20px;width: 20px;margin-right:7px;cursor: pointer;" src = "{{ asset('images/email-8-svgrepo-com.svg') }}" alt="about-solid SVG"/>null@gmail.com</a></p>
          </div>
        </div>
        <footer>
          <hr />
